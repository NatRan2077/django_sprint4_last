...
def _test_edit(
    ...
    model_adapter: ModelAdapterT,
    item: Model,
    edit_form_tester: Type[BaseFormTester],
    ...
    **update_props
    ...
    item_adapter = model_adapter(item)
    ...
    def create_updated_form(**updated_props):
        ...
        return edit_form_tester.init_create_form_from_item(
            item,
            form.__class__,
    ...
    return tester.test_edit_item(
        updated_form, qs=item_model.objects.all(), item_adapter=item_adapter
    )
